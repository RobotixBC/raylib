...
*
*   NOTES:
*       - One default RayFont is loaded on InitWindow()->LoadFontDefault() [core, text]
...
// RayFont, font texture and GlyphInfo array data
...
RLAPI RayFont LoadFontEx(const char *fileName, int fontSize, int *fontChars, int glyphCount);  // Load font from file with extended parameters, use NULL for fontChars and 0 for glyphCount to load the default character set
...
RLAPI void DrawTextPro(RayFont font, const char *text, Vector2 position, Vector2 origin, float rotation, float fontSize, float spacing, Color tint); // Draw text using RayFont and pro parameters (rotation)
...
RLAPI void DrawTextCodepoints(RayFont font, const int *codepoints, int count, Vector2 position, float fontSize, float spacing, Color tint); // Draw multiple character (codepoint)
...
//------------------------------------------------------------------------------------
typedef void (*AudioCallback)(void *bufferData, unsigned int frames, void* extra);
...
RLAPI void SetAudioStreamCallback(AudioStream stream, AudioCallback callback, void* extra);  // Audio thread callback to request new data
